    ...
    <div class="container">
        <div class="painel">
            ...
            <div class="container-04">
                ...
                <form class="form1">
                    <div class="status">Exibir produto</div>
                    
                    <div class="spacex1">
                        <div  style="display:flex;justify-content:center;" class="box1">
                            <img src="{{asset('/icons/salad-fruit.svg')}}" width="100px" height="100px" alt="">
                        </div>
                        ...
                        <div  class="box2">
                            ...
                            <div style="margin-top: -150px;" class="contentx">
                                <label style="margin-top: 40px;" for="textbox4">Quantidade</label>
                                <input class="caixa4" type="text" id="textbox" disabled required value="{{$produto->quantidade}}">
                            
                            </div>

                            <div style="margin-top: -150px;" class="contentx">
                                <label style="margin-top: 40px;" for="textbox4">Preço</label>
                                <input class="caixa5" type="text" id="textbox" disabled required value="R${{$produto->preco}}">
                            </div>
