    ...
    <div class="container">
        <div class="painel">
            ...
            <div class="container-04">
                ...
                <form class="form1" id="update-produto" method="POST" action="{{route('compras.update', $produto->id)}}">
                    <div class="status">Atualizar produto</div>
                    @csrf
                    @method('PUT')
                    <div class="spacex">
                        <div class="box">
                            ...
                            <div>
                                <input class="caixa" type="text" id="descricao" name="descricao" required value="{{$produto->descricao}}">
                            </div>
                        </div>
                        ...
                        <div class="box">
                            ...
                            <div>
                                <input class="caixa1" type="number" id="preco" name="preco" required value="{{$produto->preco}}">
                            </div>
                        </div>
                    ...
                    <div class="spacex">
                        <div class="box">
                            ...
                            <div>
                                <input class="caixa" type="number" id="quantidade" name="quantidade" required value="{{$produto->quantidade}}">
                            </div>
                        </div>

                        <div style="margin-left: 0px;" class="box">
                            <div class="input-group">
                                <button title="Salvar produto" form="update-produto" type="submit" class="btn-op">
                                ...
                                <button title="Deletar" form="delete-produto" type="submit" class="btn-op">
                                    <img style="margin-left: 10px;margin-top:0px;" src="/icons/delete.svg" width="30px" height="30px" alt="">
                                    <label class="save-text">Deletar</label> 
                                </button>
                ...
                <form method="POST" id="delete-produto"  action="{{route('compras.destroy', $produto->id) }}">
                    @csrf
                    @method('DELETE')
                </form>
